...
dataTrain = pd.read_csv("/home/global/Downloads/train.csv")
dataTest = pd.read_csv("/home/global/Downloads/test.csv")
...
submission.to_csv('/home/global/Downloads/bike_predictions_gbm_separate_without_fe.csv', index=False)
